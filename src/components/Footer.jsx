      ...
      <div className="footer-container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.manish.studymate" target="_blank" rel="noopener noreferrer" className="footer-play-badge">
              ...
              <div className="footer-play-text">
                <span className="footer-play-small">GET IT ON</span>
                <span className="footer-play-big">Google Play</span>
              </div>
            </a>
