...
export async function generateMetadata({ params }) {
  ...
  return buildMetadata({
    title: `PU Semester ${semester.semester} Syllabus - Computer Engineering`,
    description: buildSemesterDescription(semester),
    canonicalPath: scopeHref('syllabus', semester.semester),
    type: 'article',
...
export default async function Page({ params }) {
  ...
  return <BlogSemester semesterId={semesterId} scope="syllabus" />
}