...
export async function generateMetadata({ params }) {
  ...
  return buildMetadata({
    ...
    description: `Free ${subject.name} new-syllabus question papers for Pokhara University BE Computer Engineering. Board and final papers by exam year — read each paper in your browser, no login and no download.`,
